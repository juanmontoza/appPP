...
# Checkbox to add additional plot
add_additional_plot = st.checkbox('Add additional plot')

if add_additional_plot:
    # Add the sidebar options for the additional plot
    st.sidebar.header('Additional Plot Options')
